...
public class StarScriptTwoPlayer : MonoBehaviour
{
    private CoinSpawnerScriptTwoPlayer coinSpawnerScript;

    private AudioSource audioSource;

    private void Awake()
    {
        coinSpawnerScript = FindObjectOfType<CoinSpawnerScriptTwoPlayer>();
