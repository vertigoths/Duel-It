...
public class GameController : MonoBehaviour
{
    ...
    public void GeneratePlatform()
    {
        ...
        if(counter == 11)
        {
            firstBackground.transform.position = new Vector3(firstBackground.transform.position.x, firstBackground.transform.position.y + 36.9f, 0f);
            currentBackground = secondBackground;
        }


        else if((counter > 12) && ((counter % 4 == 0) || (counter % 30 == 0)))
        {
            ...
            {
                secondBackground.transform.position = new Vector3(secondBackground.transform.position.x, secondBackground.transform.position.y + 36.9f, 0f);
                currentBackground = thirdBackground;
            }

            else if (currentBackground == thirdBackground)
            {
                thirdBackground.transform.position = new Vector3(thirdBackground.transform.position.x, thirdBackground.transform.position.y + 36.9f, 0f);
                currentBackground = fourthBackground;
            }

            else
            {
                fourthBackground.transform.position = new Vector3(fourthBackground.transform.position.x, fourthBackground.transform.position.y + 36.9f, 0f);
